...
\begin{thebibliography}{99}
	...
	\weblink*{rivr}{https://ib.komisc.ru/add/rivr}{Официальный сайт проекта РИВР}{26.12.2021}
	\weblink*{esquire}{https://esquire.ru/articles/5849-cow-parsnip}{Статья в журнале Esquire, посвященная борщевику Cосновского}{12.01.2022}
	
	\weblink*{inaturalist}{https://www.inaturalist.org}{Официальный сайт проекта iNaturalist}{26.12.2021}
	\weblink*{googlemymaps}{https://www.google.com/maps/about/mymaps}{Страница с описанием сервиса Google MyMaps}{26.12.2021}
	\weblink*{plantfinder}{https://www.plantsmap.com/finder/plants}{Страница с описанием сервиса Plant Finder}{26.12.2021}
	\weblink*{floraincognita}{https://floraincognita.com}{Официальный сайт сервиса Flora Incognita}{11.01.2022}
	\weblink*{inaturalist-export}{https://www.inaturalist.org}{Официальный сайт проекта iNaturalist}{26.12.2021}
	
	
	
	\bibitem{privacy-policy} Федеральный закон от 27.07.2006 N 152-ФЗ (ред. от 02.07.2021) "О персональных данных", статья 9.1
	...
	\weblink*{flutter-vs-react}{https://dergipark.org.tr/en/download/article-file/1607441}{Сравнение
	популярных фреймворков для кроссплатформенной разработки}{18.05.2022}
	\weblink*{flutter-better}{http://www.diva-portal.org/smash/get/diva2:1442804/FULLTEXT01.pdf}{Оценка производительности популярных фреймворков для кроссплатформенной разработки}{18.05.2022}
	\weblink*{bloc-better}{https://flutterdevs.com/blog/bloc-pattern-in-flutter-part-1}{Описание архитектуры BLoC}{18.05.2022}
	...
	\weblink*{mobilenet-better}{https://arxiv.org/abs/1801.04381}{Описание модели MobileNetV2 свёрточной нейронной сети, обученной на наборе данных ImageNet}{29.05.2022}
	
	
	
	\weblink*{un-biodiv}{https://www.cbd.int/convention/text/}{United Nations Convention on Biological Diversity (CBD)}{17.05.2022}
	...
	\weblink*{postman}{https://www.postman.com/}{Официальный сайт инструмента для тестирования API \en{Postman}}{25.05.2022}
\end{thebibliography}
