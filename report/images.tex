...
\newcommand{\picturefive}{
	\begin{figure}[!htbp]
		...
		\begin{tikzpicture}[thick, node distance = 0.75cm, on grid]
			...
			\node[inner, text width=12cm, below= of nn1] (nn2) {Модель \textquote{XCeption} без \textquote{головы}};
...
\newcommand{\picturesix}{
	\begin{figure}[!htbp]
		\includegraphics[width=12cm]{head_training}
		\centering
...
\newcommand{\pictureseven}{
	\begin{figure}[!htbp]
		\includegraphics[width=12cm]{full_training}
		\centering
